...
public class BottomUpSelectDialog extends Dialog implements OnClickListener, OnItemClickListener {
    ...
    public BottomUpSelectDialog(Activity activity, int theme,
     ...
     * @param names          菜单项名称
     */
    public BottomUpSelectDialog(Activity activity, int theme, SelectDialogListener listener, SelectDialogCancelListener cancelListener, List<String> names) {
        super(activity, theme);
        mActivity = activity;
        mListener = listener;
     ...
     * @param title    菜单标题文字
     */
    public BottomUpSelectDialog(Activity activity, int theme, SelectDialogListener listener, List<String> names, String title) {
        super(activity, theme);
        mActivity = activity;
        mListener = listener;
        this.mName = names;
    ...
    public BottomUpSelectDialog(Activity activity, int theme, SelectDialogListener listener, SelectDialogCancelListener cancelListener, List<String> names, String title) {
        super(activity, theme);
        mActivity = activity;
        mListener = listener;
        mCancelListener = cancelListener;
